document.addEventListener('DOMContentLoaded', () => {
    ...
    if (registerNowTrigger) {
        registerNowTrigger.addEventListener('click', () => {
            window.location.href = '../../Onboarding/html/index.html';
        });
    }
    ...
    const goToFindRidePage = () => {
        window.location.href = '../../Ride/html/find_ride.html';
    };

    const goToOfferRidePage = () => {
        window.location.href = '../../Ride/html/offer_ride.html';
    };

    if (findRideCard) {
        findRideCard.addEventListener('click', goToFindRidePage);
    }

    if (offerRideCard) {
        offerRideCard.addEventListener('click', goToOfferRidePage);
    }

    if (findRideBtn) {
        findRideBtn.addEventListener('click', goToFindRidePage);
    }

    if (offerRideBtn) {
        offerRideBtn.addEventListener('click', goToOfferRidePage);
    }
