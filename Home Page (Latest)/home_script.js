document.addEventListener('DOMContentLoaded', () => {
    ...
    if (findRideCard) {
        findRideCard.addEventListener('click', () => {
            window.location.href = '../Offer%20Ride%20-%20Part%203%20(Latest)/html/find_ride.html';
        });
    }

    if (offerRideCard) {
        offerRideCard.addEventListener('click', () => {
            window.location.href = '../Offer%20Ride%20-%20Part%203%20(Latest)/html/offer_ride.html';
        });
    }
